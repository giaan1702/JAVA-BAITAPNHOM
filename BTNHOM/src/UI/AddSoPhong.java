...
public class AddSoPhong extends JFrame implements ActionListener {
	...
	private void initUI() {
        ...
        setSize(500, 250); // Tăng kích thước cửa sổ
        ...
        // Panel form với GridBagLayout để kiểm soát tốt hơn
        ...
        formPanel.add(lblLoaiPhong, gbc);
        ...
        cbLoaiPhong.setPreferredSize(new Dimension(200, 30)); // Tăng chiều cao
        formPanel.add(cbLoaiPhong, gbc);

        // Label và TextField Số phòng
        gbc.gridx = 0;
        gbc.gridy = 1;
        JLabel lblSoPhong = new JLabel("Số phòng:");
        lblSoPhong.setFont(new Font("Arial", Font.PLAIN, 14));
        formPanel.add(lblSoPhong, gbc);

        gbc.gridx = 1;
        gbc.gridy = 1;
        txtSoPhong = new JTextField();
        txtSoPhong.setFont(new Font("Arial", Font.PLAIN, 14));
        txtSoPhong.setPreferredSize(new Dimension(200, 30)); // Tăng chiều cao
        ...
        btnOK.setPreferredSize(new Dimension(120, 40)); // Tăng kích thước nút
        
        btnQuayLai.setFont(new Font("Arial", Font.BOLD, 14));
        btnQuayLai.setBackground(new Color(204, 0, 0));
        btnQuayLai.setForeground(Color.WHITE);
        btnQuayLai.setPreferredSize(new Dimension(120, 40)); // Tăng kích thước nút
